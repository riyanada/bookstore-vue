<template>
    <v-navigation-drawer v-model="drawer" absolute fixed clipped>
        ...
        <v-list v-if="guest">
            <v-list-item>
                <v-btn @click="register()" depressed block rounded color="accent" class="white--text">
                    Register <v-icon right dark>person_add</v-icon>
                </v-btn>
            </v-list-item>
            <v-list-item>
                <v-btn @click="login()" block rounded depressed color="primary" class="white--text">
        ...
        <v-list v-if="!guest">
            <v-list-item>
                <v-list-item-avatar>
                    <img v-if="user.avatar == null" src="img/notfound.png">
